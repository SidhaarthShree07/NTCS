    ...
    def _send_violation_event(self, event, vehicle_id=None):
        ...
        try:
            ...
            if response.status_code in [200, 201]:
                print(f"[ViolationRecorder] ✅ Violation sent successfully")
                ...
                print(f"[ViolationRecorder] ❌ API error: {response.status_code}")
            ...
            print(f"[ViolationRecorder] ❌ Failed to send violation: {e}")
            import traceback
            traceback.print_exc()
            return False
